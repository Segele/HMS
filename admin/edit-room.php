                                ...
                                <div class="card-body">
                                    <h4 class="card-title">Bed Space</h4>
                                        <div class="form-group mb-4">
                                            <select class="custom-select mr-sm-2" id="Bed Space" name="Bed Space" required="required">
                                                <option value="<?php echo $row->seater;?>"><?php echo $row->seater;?></option>
                                                <option value="1">Two Bed Space</option>
                                                <option value="2">Four Bed Space</option>
                                                <option value="3">Six Bed Space</option>
                                                <option value="4">Eight Bed Space</option>

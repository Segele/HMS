            ...
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bed Space</h4>
                                    <div class="form-group">
                                        <input type="text" id="seater" name="Bed Space" placeholder="Enter Bed Space No." required class="form-control">
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Matric Number</h4>
                                        <div class="form-group">
                                            <input type="text" name="regno" id="regno" placeholder="Enter matric number" class="form-control" required>
                                        </div>
                                </div>
                            </div>
                        </div>
